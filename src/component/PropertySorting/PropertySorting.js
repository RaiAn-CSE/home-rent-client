  ...
  return (
    <div className="sorting-section p-3">
      ...
      <Form onSubmit={handleForm}>
        ...
        <Form.Group required >
          <Form.Check name="rentType" type="checkbox" label="Apartment" value="Apartment" />
          ...
          <Form.Check name="rentType" type="checkbox" label="Restaurant" value="Restaurant" />
          <Form.Check name="rentType" type="checkbox" label="Community Center" value="Community Center" />
          <Form.Check name="rentType" type="checkbox" label="Room for Bachelor" value="Room for Bachelor" />
        </Form.Group>
